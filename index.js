...
function home() {
   ...
   document.getElementById("home").style.color = "#3a0ca3";
...
function shop() {
   ...
   document.getElementById("blog").style.color = "black";
   document.getElementById("about").style.color = "black";
   document.getElementById("shop").style.color = "#3a0ca3"
...
function blog() {
   ...
   document.getElementById("blog").style.color = "#3a0ca3"
   document.getElementById("home").style.color = "black"
   document.getElementById("shop").style.color = "black"
   document.getElementById("about").style.color = "black";
   document.getElementById("contact").style.color="black";
...
function about() {
   ...
   document.getElementById("home").style.color = "black"
   document.getElementById("shop").style.color = "black";
   document.getElementById("about").style.color = "#3a0ca3"
   document.getElementById("contact").style.color="black";
...
function contact() {
   ...
   document.getElementById("shop").style.color = "black";
   document.getElementById("about").style.color = "black";
   document.getElementById("contact").style.color="#3a0ca3"
